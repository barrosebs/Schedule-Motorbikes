    ...
    public class MotorcycleRepository : IMotorcycleRepository
    {
        ...
        public async Task CreateAsync(MotorcycleModel motorcycle)
        {
            try
            {
                ...
                await using var cmd = new NpgsqlCommand("INSERT INTO motorcycle (id,model, year,license_plate, datecreated) VALUES (@Id,@model, @year, @licenseplate,@datecreated)", conn);
